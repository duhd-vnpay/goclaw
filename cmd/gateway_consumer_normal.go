...
func processNormalMessage(
	...
	projectID, projectOverrides := resolveProjectOverrides(ctx, deps.ProjectStore, channelType, msg.ChatID)

	agentLoop, err := deps.Agents.GetForProject(ctx, agentID, projectID, projectOverrides)
	if err != nil {
