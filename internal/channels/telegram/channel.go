...
type Channel struct {
	*channels.BaseChannel
	...
	pairingHandler    *channels.PairingHandler    // email-OTP pairing handler (nil if not configured) — LOCAL fork
	pairingFlows      sync.Map                    // senderID string → *channels.PairingFlowEntry — LOCAL fork
