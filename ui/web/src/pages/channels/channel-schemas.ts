...
export const configSchema: Record<string, FieldDef[]> = {
  ...
  google_chat: [
    ...
    { key: "projectId", label: "GCP Project ID", type: "text", required: true, placeholder: "my-gcp-project" },
    { key: "subscriptionId", label: "Pub/Sub Subscription", type: "text", required: true, placeholder: "my-chat-sub", help: "Pub/Sub subscription for Google Chat events" },
    { key: "pullIntervalMs", label: "Pull Interval (ms)", type: "number", defaultValue: 3000, help: "Pub/Sub pull frequency" },
    { key: "botUser", label: "Bot User Email", type: "text", placeholder: "bot@project.iam.gserviceaccount.com", help: "Service account email to filter self-messages" },
    ...
    { key: "longFormThreshold", label: "Long-Form Threshold", type: "number", defaultValue: 3500, help: "Character count above which content is uploaded as a Drive file (0 = disabled)" },
    { key: "longFormFormat", label: "Long-Form Format", type: "select", options: [{ value: "md", label: "Markdown (.md)" }, { value: "txt", label: "Plain text (.txt)" }], defaultValue: "md" },
    { key: "mediaMaxMb", label: "Max Media Size (MB)", type: "number", defaultValue: 20 },
    { key: "fileRetentionDays", label: "Drive File Retention (days)", type: "number", defaultValue: 7, help: "Auto-delete uploaded Drive files after N days (0 = keep forever)" },
    { key: "drivePermission", label: "Drive Permission", type: "select", options: [{ value: "domain", label: "Domain" }, { value: "anyone", label: "Anyone with link" }], defaultValue: "domain" },
    { key: "driveDomain", label: "Drive Domain", type: "text", placeholder: "example.com", help: "Domain for domain-scoped Drive sharing" },
