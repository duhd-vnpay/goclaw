...
const ns = [
  ...
  "setup", "memory", "storage", "pending-messages", "party", "contacts", "activity", "api-keys",
  "cli-credentials",
] as const;
...
i18n.use(initReactI18next).init({
  resources: {
    en: {
      ...
      party: enParty, contacts: enContacts, activity: enActivity, "api-keys": enApiKeys,
    ...
    vi: {
      ...
      party: viParty, contacts: viContacts, activity: viActivity, "api-keys": viApiKeys,
    ...
    zh: {
      ...
      party: zhParty, contacts: zhContacts, activity: zhActivity, "api-keys": zhApiKeys,
