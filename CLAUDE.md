...
This project is indexed by GitNexus as **goclaw** (27351 symbols, 123949 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/goclaw/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/goclaw/context` | Codebase overview, check index freshness |
| `gitnexus://repo/goclaw/clusters` | All functional areas |
| `gitnexus://repo/goclaw/processes` | All execution flows |
| `gitnexus://repo/goclaw/process/{name}` | Step-by-step execution trace |
